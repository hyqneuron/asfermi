/*
This file contains various helper functions used during the parsing stage (the processing stage)
all functions are prefixed with 'hpParse'
*/

#ifndef helperParseDefined //prevent multiple inclusion
//---code starts ---
